# ЛР-3 по ООП на ФИИТе в МАИ
Лабораторная работа №3 по дисциплине "Объектно-ориентированное программирование" в третьем семестре 2025/2026 учебного года направления "Фундаментальная информатика и информационные технологии" в [Московском авиационном институте](https://mai.ru)
...
### Содержание (вариант 23)
Разработать программу на языке **C++**, которая должна собираться с помощью системы сборки **CMake**, получать данные из стандартного ввода (`std::cin`) и выводить данные в стандартный вывод (`std::cout`).

Разработать классы согласно варианту задания, которые должны наследоваться от базового класса `Figure` и быть помещены в отдельный файл.
...
Фигуры являются фигурами вращения и имеют равные стороны.
